...
RSpec.describe SemanticSimilarity do
  describe "intialize input parameter" do
    describe "first question" do
      context "when is less than 3 characters" do
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, first_question: "a?" }
        it { is_expected.to raise_error(ArgumentError, "first_question must be greater than or equal to 3 characters.") }
      end
      ...
      context "when is greater than 140 characters" do
        ...
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, first_question: first_question }
      ...
      context "when doesn't end in a question mark" do
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, first_question: "Do you know what the value of pi is." }
    ...
    describe "second question" do
      context "when is less than 3 characters" do
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, second_question: "a?" }
      ...
      context "when is greater than 140 characters" do
        ...
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, second_question: second_question }
        it { is_expected.to raise_error(ArgumentError, "second_question must be lower than or equal to 140 characters.") }
      end

      context "when doesn't end in a question mark" do
        subject(:semantic_similarity) { FactoryBot.create :semantic_similarity, second_question: "Do you know what the value of pi is." }
  ...
  describe "instance attribute" do
    describe "score" do
      let(:semantic_similarity) { FactoryBot.create :semantic_similarity }
      subject(:score) { semantic_similarity.score }
    ...
    describe "same_question?" do
      context "when the first question is 'Do you know if this film is available in color?'" do
        ...
        context "and the second question is 'Are you aware whether this movie exists not in black and white?'" do
          ...
          let(:semantic_similarity) { FactoryBot.create :semantic_similarity, first_question: first_question, second_question: second_question }
          subject(:same_question?) { semantic_similarity.same_question? }
