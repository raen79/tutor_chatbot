  ...
  describe 'intialize input parameter' do
    describe 'first question' do
      context 'when is less than 3 characters' do
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, first_question: 'a?' }
      ...
      context 'when is greater than 140 characters' do
        ...
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, first_question: first_question }
      ...
      context 'when doesn\'t end in a question mark' do
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, first_question: 'Do you know what the value of pi is.' }
    ...
    describe 'second question' do
      context 'when is less than 3 characters' do
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, second_question: 'a?' }
      ...
      context 'when is greater than 140 characters' do
        ...
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, second_question: second_question }
        it { is_expected.to raise_error(ArgumentError, 'second_question must be lower than or equal to 140 characters.') }
      end

      context 'when doesn\'t end in a question mark' do
        subject(:semantic_similarity) { FactoryBot.build :semantic_similarity, second_question: 'Do you know what the value of pi is.' }
